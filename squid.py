...
def mask_overlay(image, faces):
    ...
    for i in faces[0]:
        ...
        #    if mirror_point[i[0]] in extend_x:
        #     face_points[mirror_point[j]]=[float(i[1]-10),float(i[2])]
        #    else:
        #     face_points[mirror_point[j]]=[float(i[1]),float(i[2])]
    ...
    #   move_y=height-h
    #   dim = (width, height)
    #   resized = cv2.resize(png_image, dim, interpolation = cv2.INTER_AREA)
    #   print(resized.shape)
